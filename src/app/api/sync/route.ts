  ...
  try {
    ...
    try {
      ...
      const sync = db.transaction(() => {
        ...
        // Clear ALL stale bot-queue match todos — they were generated by the pre-Phase1
        // engine with no penalty logic. The new engine will create better ones.
        db.prepare(`DELETE FROM todos WHERE queue = 'bot' AND todo_type = 'match'`).run();
