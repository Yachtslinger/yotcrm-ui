...
import {
  ...
  Upload, CreditCard, Globe, BookOpen, Grid, DollarSign, BarChart2, Inbox,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/match-board",    label: "Match Board",    Icon: Anchor,      color: "#dc2626", group: "core" },
  { href: "/profile-review", label: "Profile Review", Icon: CheckSquare, color: "#16a34a", group: "core" },
  { href: "/contact-triage", label: "Contact Triage", Icon: Search,      color: "#0891b2", group: "core" },
