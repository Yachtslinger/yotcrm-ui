...
const PUBLIC_PATHS = ["/login", "/api/auth", "/api/health", "/api/sync", "/api/clients/recent", "/api/emails", "/api/cards/leads", "/api/cards/views", "/card", "/api/matches/ingest", "/api/public", "/home", "/listing", "/api/listings/files", "/api/listings/debug", "/api/brochures", "/email/", "/bookmarklet", "/api/brochures/ingest", "/api/comms/ingest"];
